...
public class TableDetailActivity extends AppCompatActivity {
        ...
        if (currentTable != null && currentTable.getId() > 0) {
            ...
            if (currentOrder != null) {
                ...
                if (orderItems != null && !orderItems.isEmpty()) {
                    ...
                    // Hiển thị tổng tiền
                    textViewOrderTotal.setText(currencyFormat.format(currentOrder.getTotalAmount()));
                    
                    // Hiển thị phần chi tiết đơn hàng
    ...
    private void confirmCheckout() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Thanh toán", (dialog, which) -> {
                    ...
                    Intent intent = new Intent(TableDetailActivity.this, CheckoutActivity.class);
                    intent.putExtra("order", currentOrder);
                    intent.putExtra("tableId", currentTable.getId());
                    intent.putExtra("tableName", currentTable.getName());
                    startActivityForResult(intent, REQUEST_CHECKOUT_ACTIVITY);
                })
                .setNegativeButton(R.string.cancel, null)
                .show();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        else if (requestCode == REQUEST_CHECKOUT_ACTIVITY && resultCode == RESULT_OK) {
            // Thanh toán thành công, cập nhật trạng thái bàn về "Trống"
            if (currentTable != null) {
                String availableStatus = getString(R.string.status_available);
